    ...
    products: [
        {
            ...
            variety: {
                varietyName: { type: String, required: function () { return !this.isItem; } }, // Name of variety (e.g., "Chocolate", "Vanilla")
                varietyMeasurement: { type: String, required: function () { return !this.isItem; } } // Measurement if applicable (e.g., "250g", "500ml")
            }
        }
    ]
}, { timestamps: true });
