function openCategoryModal() {
    ...
    async function openEditModal(categoryId,categoryName,categoryDescription,categoryImage){
    ...
    $("#editCategoryForm").on("submit",async (e)=>{
      ...
      formData.append('categoryImage', document.getElementById('ecategoryImage').files[0]);
