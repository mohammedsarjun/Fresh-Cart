$(document).ready(() => {
    ...
    submitCategoryForm.click((e) => {
        ...
        if (categoryName.length === 0) {
            ...
            e.preventDefault();
            $("#categoryNameError").text("Category name can only contain letters, numbers, spaces, hyphens (-), or underscores (_). It must start and end with a letter or number.");
        } else {
        ...
        if (categoryDescription.length === 0) {
            ...
            e.preventDefault();
            $("#categoryDescriptionError").text("Category description can only contain letters, numbers, spaces, hyphens (-), or underscores (_). It must start and end with a letter or number.");
        } else {
