...
async function updateCoupon(e) {
  try {
    ...
    let updateListingStatus = document.getElementById(
      'updateListingStatus'
    ).value;
...
async function openUpdateCouponModal(
  couponId,
  couponCode,
  discountPercentage,
  couponStartDate,
  ...
  // var myModal = new bootstrap.Modal(document.getElementById('editProductModal')); // Your original date format (DD/MM/YYYY)
  ...
  isListed = document.getElementById('updateCouponName').value = couponCode;
