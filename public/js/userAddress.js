...
submitAddressBtn.click((e) => {
  ...
  if ($("#addAddressLastName").val().trim().length > 0 && !namePattern.test($("#addAddressLastName").val().trim())) {
    e.preventDefault();
  ...
  if ($("#addAddressLine2").val().trim().length > 0 && !addressPattern.test($("#addAddressLine2").val().trim())) {
    e.preventDefault();
